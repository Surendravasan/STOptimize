...
public class _signUpPage {
	...
	@FindBy(xpath="//div[text()='Single Market']/ancestor::div[@class='card']//button")
	protected WebElement $singleMarket;
	...
	@FindBy(css="div.user-details input[name='phone']")
	...
	@FindBy(css="div[class*='billing-content'] button[class*='next-btn']")
	protected WebElement $billingNext;
